...
import userImg from "@/assets/image/admin.jpeg";
  ...
  return (
    <Fragment>
      <Row className="gy-4 gx-4">
        ...
        <Col md={6} lg={4}>
          <Card title="Profile Card">
            <CardBody className="p-0">
              <ProfileCard userName=" Proph Euloge Ekissi" image={userImg}>
                <span>
        ...
        <Col md={6} lg={4}>
          <Card title="Card with switch" badgeLabel="Success" badgeBg="success">
            <CardBody>
              <p style={{ color: "var(--hedging-text-color)" }}>
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
        ...
        <Col md={6} lg={4}>
          <Card title="Card with switch" badgeLabel="49" badgeBg="danger">
            <CardBody>
              <p style={{ color: "var(--hedging-text-color)" }}>
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
        ...
        <Col md={6} lg={4}>
          <Card isHeader={false}>
            ...
            >
              <p className="text-light">- Someone famous in Source Title</p>
            </CardFooter>
          </Card>
        </Col>
        <Col md={6} lg={4}>
        ...
        <Col md={6} lg={4}>
          <Card isHeader={false}>
            ...
            <CardBody>
              <CardTitle style={{ color: "var(--hedging-text-color)" }}>
                Card Image Title
              </CardTitle>
              <CardText style={{ color: "var(--hedging-text-color)" }}>
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
              </CardText>
            </CardBody>
